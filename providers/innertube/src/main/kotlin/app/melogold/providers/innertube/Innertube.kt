package app.melogold.providers.innertube

import app.melogold.providers.innertube.models.MusicNavigationButtonRenderer
import app.melogold.providers.innertube.models.NavigationEndpoint
import app.melogold.providers.innertube.models.Runs
import app.melogold.providers.innertube.models.Thumbnail
...
object Innertube {
    ...
    data class ArtistPage(
        ...
        val videosEndpoint: NavigationEndpoint.Endpoint.Browse? = null,
        val relatedArtists: List<ArtistItem>? = null
    )
